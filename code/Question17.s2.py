#Question 17 : comparaison du temps de calcul de la méthode de la dernière question à celle de la question 13
import numpy as np
...
start_time=time.time()
Z=[Chi2finale() for i in range(nbs)]
print('le temps de calcul par la méthode de la question 16 est :',time.time()-start_time)